...
TrustVault's central claim is \emph{trustless verification}: a verifier does not need to trust any single server, institution, or even the canister code to confirm that a credential is authentic. This section analyzes why specific attack vectors fail against TrustVault's design.
...
TrustVault's trustless verification requires only two assumptions:
\begin{enumerate}
