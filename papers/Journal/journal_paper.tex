...
\texttt{block\_timestamp}   & Int64  & Consensus timestamp (ns) \\
...
\paragraph{Payload.}
\texttt{issueCertificate} takes 12 text fields and one float. A representative call (names~$\approx$30\,B, IDs~$\approx$15\,B, dates~$\approx$10\,B, degree/major/URL~$\approx$30\,B each, Candid framing~$\approx$50\,B) totals $\approx$400\,bytes.
