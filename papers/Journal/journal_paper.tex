...
\begin{enumerate}
  ...
  \item \textbf{Direct cycle instrumentation}: Measuring actual cycle consumption via ICP's \texttt{ExperimentalInternetComputer.countInstructions} API to validate and refine the cost estimate in Section~\ref{sec:discussion}.
\end{enumerate}
